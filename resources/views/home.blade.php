    ...
    <div class="row">
        <div class="col-md-8">
             ...
             <div id="filterdate" class="collapse">
                ...
                <!-- <div class="col-md-3"> -->
                    <input type="submit" name="submit" class="btn btn-secondary round mr-1 mb-1" value="Search">
                <!-- </div> -->
        </form>
...
$('#expereincesearch').on('change',function(e){
    if($(this).val()==1){
        $('#expereincepanelsearch').collapse('show');
    }
    if($(this).val()==0){
        $('#expereincepanelsearch').collapse('hide');
    }
});
